...
class Dashboard extends React.Component {
 ...
 return sum1=parseInt(sum1)+parseInt(p.qty)
 })
 console.log(sum1)
...
{ 
 ...
 <option value={o}>{o}</option>
  ...
  <div className="container" style={{padding:'0px',height:'100%',marginTop:'50px',alignContent:'center'}}> 
 <Chart 
 chartType="Bar"
